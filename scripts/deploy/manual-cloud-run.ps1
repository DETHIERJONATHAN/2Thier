...
$setEnvVars = "NODE_ENV=production,VITE_GA4_ID=G-GZ4FXQDH6D,PGHOST=/cloudsql/thiernew:europe-west1:crm-postgres-prod,PGDATABASE=2thier,PGUSER=postgres,FRONTEND_URL=https://www.zhiive.com,BACKEND_URL=https://www.zhiive.com,GCS_BUCKET=crm-2thier-uploads,SMTP_HOST=send.one.com,SMTP_PORT=465,SMTP_USER=contact@zhiive.com,SMTP_FROM=contact@zhiive.com,POSTAL_API_URL=https://postal.zhiive.com,POSTAL_SMTP_HOST=postal.zhiive.com,POSTAL_SMTP_PORT=25,POSTAL_SMTP_USER=zhiive-mail,DEFAULT_EMAIL_DOMAIN=zhiive.com,SEARXNG_URL=http://46.225.180.8:8888,VAPID_SUBJECT=mailto:contact@zhiive.com,ODOO_URL=http://46.225.180.8:8069,ODOO_DB_NAME=odoo_peppol,ODOO_USER=admin"
