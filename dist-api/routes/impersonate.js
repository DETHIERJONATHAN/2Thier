...
router.post('/', auth_1.authMiddleware, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, userId, organizationId, currentUser;
    return __generator(this, function (_b) {
        try {
            _a = req.body, userId = _a.userId, organizationId = _a.organizationId;
            console.log('[Impersonate Route] Nouvelle demande d\'usurpation:', { userId: userId, organizationId: organizationId });
            ...
            console.log('[Impersonate Route] Usurpation autorisée pour:', { userId: userId, organizationId: organizationId });
...
router.delete('/', auth_1.authMiddleware, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var currentUser;
