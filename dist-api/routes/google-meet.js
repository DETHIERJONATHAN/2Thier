...
// Routes Google Meet
router.get('/meetings', auth_js_1.authMiddleware, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
router.get('/analytics', auth_js_1.authMiddleware, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
...
router.post('/meetings', auth_js_1.authMiddleware, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var meetingData;
    return __generator(this, function (_a) {
        try {
            meetingData = req.body;
            // TODO: Implémenter la création de réunions Google Meet
            res.json(__assign(__assign({ id: 'temp-meeting-id' }, meetingData), { message: 'Création Google Meet à implémenter' }));
        }
        catch (error) {
...
router.post('/join/:meetingCode', auth_js_1.authMiddleware, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var meetingCode;
    return __generator(this, function (_a) {
        try {
...
router.post('/instant', auth_js_1.authMiddleware, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
...
router.delete('/meetings/:meetingId', auth_js_1.authMiddleware, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var meetingId;
    return __generator(this, function (_a) {
        try {
