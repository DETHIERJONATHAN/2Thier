                                                            ...
                                                            data: {
                                                                ...
                                                                meta: (function () {
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        if ((_p = metaObj === null || metaObj === void 0 ? void 0 : metaObj.lookup) === null || _p === void 0 ? void 0 : _p.displayColumn) {
                                                                            if (Array.isArray(metaObj.lookup.displayColumn)) {
                                                                                metaObj.lookup.displayColumn = metaObj.lookup.displayColumn.map(function (col) {
                                                                                    if (col && !/^-?\d+(\.\d+)?$/.test(col.trim()) && !col.endsWith(computedLabelSuffix)) {
                                                                                        console.log("[table.meta] displayColumn[]: ".concat(col, " \u2192 ").concat(col).concat(computedLabelSuffix));
                                                                                        return "".concat(col).concat(computedLabelSuffix);
                                                                                    }
                                                                                    return col;
                                                                                });
                                                                            }
                                                                            else if (typeof metaObj.lookup.displayColumn === 'string') {
                                                                                var val = metaObj.lookup.displayColumn;
                                                                                if (!/^-?\d+(\.\d+)?$/.test(val.trim()) && !val.endsWith(computedLabelSuffix)) {
                                                                                    console.log("[table.meta] displayColumn: ".concat(val, " \u2192 ").concat(val).concat(computedLabelSuffix));
                                                                                    metaObj.lookup.displayColumn = "".concat(val).concat(computedLabelSuffix);
                                                                                }
                                                                            }
                                                                        }
                                                                        // 🔥 FIX: Suffixer displayRow (peut être string ou array)
                                                                        if ((_q = metaObj === null || metaObj === void 0 ? void 0 : metaObj.lookup) === null || _q === void 0 ? void 0 : _q.displayRow) {
                                                                            if (Array.isArray(metaObj.lookup.displayRow)) {
                                                                                metaObj.lookup.displayRow = metaObj.lookup.displayRow.map(function (row) {
                                                                                    if (row && !/^-?\d+(\.\d+)?$/.test(row.trim()) && !row.endsWith(computedLabelSuffix)) {
                                                                                        console.log("[table.meta] displayRow[]: ".concat(row, " \u2192 ").concat(row).concat(computedLabelSuffix));
                                                                                        return "".concat(row).concat(computedLabelSuffix);
                                                                                    }
                                                                                    return row;
                                                                                });
                                                                            }
                                                                            else if (typeof metaObj.lookup.displayRow === 'string') {
                                                                                var val = metaObj.lookup.displayRow;
                                                                                if (!/^-?\d+(\.\d+)?$/.test(val.trim()) && !val.endsWith(computedLabelSuffix)) {
                                                                                    console.log("[table.meta] displayRow: ".concat(val, " \u2192 ").concat(val).concat(computedLabelSuffix));
                                                                                    metaObj.lookup.displayRow = "".concat(val).concat(computedLabelSuffix);
                                                                                }
                                                                            }
                                                                        }
