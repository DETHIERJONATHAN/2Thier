...
import { FaExchangeAlt, FaSearch, FaChevronDown } from 'react-icons/fa';
    ...
    <header className="h-16 bg-[#1F3B53] text-white shadow-md">
      <div className="h-full flex justify-between items-center px-4">
        ...
        <div className="flex items-center space-x-6">
          ...
          <nav className="hidden lg:flex items-center space-x-1">
            ...
            <div className="relative">
              ...
              {modulesOpen && (
                <div className="absolute top-full left-0 w-64 mt-1 py-2 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50">
                  {modules.map(module => (
                    <Link
                      key={module.key}
                      to={module.route || '#'}
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* Sélecteur d'organisation intégré */}
