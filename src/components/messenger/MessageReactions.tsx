  ...
  return (
    <div className="flex flex-wrap gap-1 mt-1">
      {Object.values(grouped).map(({ emoji, users, hasMyReaction }) => (
        ...
        >
          <button
            ...
            className={`
              inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-full text-xs cursor-pointer
      ...
      <EmojiReactionPicker onSelect={onToggleReaction} placement="top">
        <button
          className="inline-flex items-center px-1.5 py-0.5 rounded-full text-xs cursor-pointer
