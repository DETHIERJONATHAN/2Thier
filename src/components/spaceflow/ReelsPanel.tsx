...
const ReelsPanel: React.FC<ReelsPanelProps> = ({ api, currentUser: _currentUser }) => {
  ...
  const loadReels = async () => {
    try {
      setLoading(true);
      const data = await api.get('/spaceflow/explore/posts?limit=20');
  ...
  const getDemoReels = (): Reel[] => [
    { id: 'd1', authorName: 'SpaceFlow', caption: '🚀 Bienvenue sur les Reels SpaceFlow ! Partagez vos moments créatifs en vidéo courte.', mediaUrl: '', mediaType: 'image', likesCount: 234, commentsCount: 18, sharesCount: 5, isLiked: false, hashtags: ['SpaceFlow', 'Reels'], musicName: '🎵 Trending Sound' },
    { id: 'd2', authorName: 'Créateur Pro', caption: '💡 Montrez votre savoir-faire ! Chantiers, installations, tutoriels...', mediaUrl: '', mediaType: 'image', likesCount: 156, commentsCount: 12, sharesCount: 3, isLiked: false, hashtags: ['Pro', 'Tutoriel'], musicName: '🎵 Creative Vibes' },
    { id: 'd3', authorName: 'L\'équipe', caption: '🎬 Filmez vos réalisations et inspirez la communauté !', mediaUrl: '', mediaType: 'image', likesCount: 89, commentsCount: 7, sharesCount: 2, isLiked: false, hashtags: ['Motivation', 'Team'] },
  ];
  ...
  return (
    <div style={{ height: '100%', background: SF.dark, position: 'relative' }}>
      ...
      <div style={{
        ...
        <div onClick={() => {/* TODO: open camera */}} style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                ...
                <span style={{
                  ...
                  background: SF.primary, color: '#fff', fontWeight: 600,
                }}>
                  Suivre
                </span>
              </div>
