...
const DebugAuth: React.FC = React.memo(() => {
  ...
  return (
    <Card 
      className="mt-8 shadow-lg border border-gray-200"
      title={
        <div className="flex items-center gap-3">
          <BugOutlined className="text-blue-600" />
          <Text strong className="text-xl">Informations de Débogage - Authentification</Text>
        </div>
      }
      extra={
        <Space>
    ...
    >
      {loading ? (
        ...
        <>
            ...
            <Col xs={24} sm={6}>
              <Card size="small" className="text-center shadow-sm">
                <Statistic
                  ...
                  valueStyle={{ color: isSuperAdmin ? '#52c41a' : '#faad14', fontSize: '1.2rem' }}
                  prefix={<TeamOutlined />}
                />
              </Card>
            </Col>
          ...
          <Collapse defaultActiveKey={['user', 'organization', 'permissions']} className="mb-4">
