...
import DragDropLeadStatus from '../../components/DragDropLeadStatus';
          ...
          <Row gutter={24}>
            <Col span={12}>
              <Card title="Gestion des Statuts d'Appels" extra={
                ...
                <div className="space-y-4">
                  ...
                  {/* Liste des statuts d'appels avec CRUD */}
                  ...
                  <div className="mt-4 p-3 bg-blue-50 rounded border border-blue-200">
                    <Text className="text-blue-800 text-sm">
                      <strong>💡 Astuce :</strong> Glissez un statut d'appel vers un statut de lead (colonne de droite) 
                      pour créer une liaison automatique. Les modifications sont sauvegardées en temps réel.
                    </Text>
                  </div>
                </div>
              </Card>
            ...
            <Col span={12}>
              ...
              >
                <div className="space-y-4">
                  <Alert 
                    message="Zone de destination pour les liaisons" 
                    description="Accepte les statuts d'appel glissés depuis la colonne de gauche pour créer des mappings automatiques."
                    type="success" 
                    showIcon
                    className="mb-4" 
                  />
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <div 
                          ...
                          style={{ backgroundColor: mapping.callStatus.color }}
                        />
                        <Tooltip title={mapping.callStatus.description}>
                          <span className="font-medium cursor-help">
                            {mapping.callStatus.name}
                          </span>
                        </Tooltip>
                      ...
                      <div className="flex items-center space-x-2">
                        <div 
                          className="w-3 h-3 rounded-full" 
                          style={{ backgroundColor: mapping.leadStatus.color }}
                        />
                        <Tooltip title={mapping.leadStatus.description}>
                          <span className="font-medium cursor-help">
                            {mapping.leadStatus.name}
                          </span>
                        </Tooltip>
