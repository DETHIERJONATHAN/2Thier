...
export interface FormulaItem {
  ...
  id?: string;      // Pour les champs (field)
  value?: any;    // Pour les opérateurs, les valeurs constantes ou le nom de la fonction
  label?: string;   // Pour l'affichage (ex: label du champ)
}
...
export interface FieldDependency {
  ...
  targetFieldId: string;
  defaultValue?: any; // Pour l'action setValue
}
...
export interface Field {
  ...
  advancedConfig?: Record<string, any>; // Ajout pour la config avancée ultra-modulaire
  formulas?: Formula[];
